package me.nalab.luffy.api.acceptance.test.feedback.findbookmarkedfeedback;
...
import me.nalab.luffy.api.acceptance.test.feedback.FeedbackAcceptanceValidator;
...
class BookmarkedFeedbackFindAcceptanceTest extends AbstractFeedbackTestSupporter {
	...
	@Test
	@DisplayName("북마크된 피드백이 없다면, 빈 값을 반환한다.")
	void RETURN_EMPTY_FEEDBACKS_IF_NON_BOOKMARKED_FEEDBACK() throws Exception {
		// given
		String token = "token";
		...
		// then
		FeedbackAcceptanceValidator.assertIsBookmarkedFeedbackEmpty(resultActions);
	}
